# Guia Única de Identidad Digital
...
### 3.4 Almacenamiento de Recursos (Assets)
Los archivos originales de identidad se encuentran centralizados en la librería para su uso en cualquier plataforma:
- **Logo Principal**: `UX_Library/assets/logo.png` o el recurso institucional definido por el proyecto.
- **Paquete de Favicon**: `UX_Library/assets/favicon/` (Incluye manifest y tamaños PWA)
